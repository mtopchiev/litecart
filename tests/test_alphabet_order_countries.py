...
def test_SortCountryInGeozones(app):
    app.login_admin()
    app.driver.get("http://localhost/litecart/admin/?app=countries&doc=countries") # открыли список стран
    ...
    for j in range (1, len_countries_with_Geozones):
...
##########
    ...
    # css ("table td:nth-of-type(5)") столбец
# $x  ("(//table//td[6][contains(.,'0')])")   все нули крому двух 236
#
# $x("(//table//td[6][not (contains(.,'0'))])")   вычислил двоих не нулевых
#
# $x("(//table//td[6][not (contains(.,'0'))])[2]")
